...
export default function AuthPage() {
  ...
  async function handleRegister(e: React.FormEvent) {
    e.preventDefault()
    setError(''); setLoading(true)
    const ADMIN_EMAIL = import.meta.env.VITE_ADMIN_EMAIL || 'rathirahulraj@gmail.com'
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--gray-50)', padding: '1rem' }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <div style={{ fontSize: 18, fontWeight: 600 }}>Vessel Manifest Exchange</div>
          <div style={{ fontSize: 13, color: 'var(--text-muted)', marginTop: 4 }}>Industry manifest sharing platform</div>
        </div>
