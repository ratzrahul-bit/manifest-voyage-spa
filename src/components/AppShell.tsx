      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '1.5rem 1.5rem 0' }}>
        <div className="topbar">
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 32, height: 32, background: 'var(--blue-light)', borderRadius: 'var(--radius)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16 }}>🏔️</div>
            <div>
              <div style={{ fontSize: 14, fontWeight: 600 }}>Himalayan Manifest</div>
              <div style={{ fontSize: 11, color: 'var(--text-muted)' }}>Free tool for manifest exchange for Nepal/Bhutan Transhipment Cargo</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
